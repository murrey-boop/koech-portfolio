...
const extras = [
  { icon: "📰", title: "Newsletter Writing", description: "Engaging email newsletters that keep your audience coming back every week." },
  { icon: "📱", title: "Social Media Copy", description: "Punchy, on-brand captions and posts for LinkedIn, Instagram, and more." },
  { icon: "📄", title: "Case Studies", description: "Compelling client success stories that build trust and close deals." },
  { icon: "🔄", title: "Content Strategy", description: "A clear content plan aligned with your goals, audience, and SEO targets." },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="SEO content writing, blog writing, website copywriting, editing and proofreading services by Josphat Koech." />
      </Helmet>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "clamp(48px,8vw,80px) 24px" }}>
        <div style={{ textAlign: "center", marginBottom: "clamp(40px,6vw,64px)" }}>
          ...
          <p style={{ color: "var(--color-ink-soft)", fontSize: "1.05rem", maxWidth: 540, margin: "0 auto", lineHeight: 1.7 }}>
            From a single blog post to an ongoing content partnership — here's how I can help.
          </p>
        </div>
        ...
        <div style={{ textAlign: "center", padding: "clamp(36px,6vw,56px) clamp(24px,4vw,40px)", borderRadius: 20, background: "linear-gradient(135deg,#f4d9d0,#fff7f1)", border: "1px solid #f4d9d0" }}>
          <h2 style={{ fontFamily: "'Playfair Display',Georgia,serif", fontSize: "clamp(1.5rem,3vw,2rem)", color: "#271d1e", margin: "0 0 12px" }}>Not sure what you need?</h2>
          <p style={{ color: "#6b5d5f", marginBottom: 28 }}>Let's talk it through — no pressure, no jargon.</p>
