  ...
  return (
    <section style={{padding:"96px 24px", textAlign:"center"}}>
      <div style={{maxWidth:700, margin:"0 auto"}}>
        <h2 style={{fontFamily:"'Playfair Display',Georgia,serif", fontSize:"clamp(1.8rem,3vw,2.8rem)", color:"#271d1e", marginBottom:20}}>
          Let's get your content sorted
        </h2>
        <p style={{color:"#6b5d5f", fontSize:"1.1rem", marginBottom:32}}>
